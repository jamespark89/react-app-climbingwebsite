...
export default function privacy() {
  return (
    <div className="privacy">
      ...
      <p>
        s s We use Your Personal data to provide and improve
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;the Company&quot;, &quot;We&quot;,
            &quot;Us&quot; or &quot;Our&quot; in this
            Agreement) refers to climbingaustralia.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Country</strong> refers to: Victoria,
            Australia
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            ...
            climbingaustralia, accessible from
            <a
              href="www.climbingaustralia.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              www.climbingaustralia.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By phone number: 0311111111</li>
      </ul>
      at:
    </div>
  )
